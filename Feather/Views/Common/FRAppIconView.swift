...
struct FRAppIconView: View {
	...
	@AppStorage("AppMaster.userTintColor") private var selectedColorHex: String = "#848ef9"
	@AppStorage("AppMaster.shouldTintIcons") private var shouldTintIcons: Bool = false
	@AppStorage("AppMaster.shouldChangeIconsBasedOffStyle") private var shouldChangeIconsBasedOffStyle: Bool = false
