...
struct SourceAppsView: View {
	@AppStorage("AppMaster.sortOptionRawValue") private var _sortOptionRawValue: String = SortOption.default.rawValue
	@AppStorage("AppMaster.sortAscending") private var _sortAscending: Bool = true
