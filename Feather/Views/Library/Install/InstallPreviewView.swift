...
struct InstallPreviewView: View {
	...
	@AppStorage("AppMaster.useShareSheetForArchiving") private var _useShareSheet: Bool = false
	@AppStorage("AppMaster.installationMethod") private var _installationMethod: Int = 0
	@AppStorage("AppMaster.serverMethod") private var _serverMethod: Int = 0
	...
	init(app: AppInfoPresentable, isSharing: Bool = false) {
		...
		let viewModel = InstallerStatusViewModel(isIdevice: UserDefaults.standard.integer(forKey: "AppMaster.installationMethod") == 1)
